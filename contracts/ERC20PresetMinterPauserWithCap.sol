...
contract ERC20PresetMinterPauser is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
    ...
    function setCap(uint newCap) internal {
        require(hasRole(CAP_ROLE, _msgSender()), "ERC20PresetMinterPauser: must have minter role to modify cap");
        require(newCap > 0, "0 cap"); 
        _cap = newCap;
    }
